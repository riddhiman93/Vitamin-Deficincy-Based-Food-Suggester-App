...
root.resizable(0,0)
root.title("Vitamin Deficiency Based Food Suggestor")
#Functions
def suggestvitamin():
...
#Labels
headinglbl=Label(root,text="Vitamin Deficiency Based Food Suggestor",fg="red",font=('Helvetica', 22, 'bold'),padx=0,pady=0).place(x=100,y=50)
